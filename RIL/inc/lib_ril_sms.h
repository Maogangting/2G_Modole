...
#define LIB_SMS_CHECK_PDU_STR(PDUStr,PDUStrLen,Result) \
    ...
    {   \
        LIB_SMS_PDUParamStruct *pTmpZA = NULL;    \
            \
        pTmpZA = (LIB_SMS_PDUParamStruct*)ol_mem_alloc(sizeof(LIB_SMS_PDUParamStruct));    \
        if(NULL == pTmpZA)    \
        {   \
            (Result) = FALSE;   \
            break;  \
...
******************************************************************************/
extern ol_bool LIB_SMS_IsValidHexStr(char *pHexStr,u16 uHexStrLen);
...
******************************************************************************/
extern ol_bool LIB_SMS_ConvHexOctToHexStr(const u8 *pSrc,u16 uSrcLen, char *pDest, u16 *pDestLen);
...
*              4. If this function works SUCCESS,<*pDestLen> will return the bytes of <pDest> buffer that has been written.
******************************************************************************/
extern ol_bool LIB_SMS_ConvHexStrToHexOct(const char *pSrc,u16 uSrcLen, u8 *pDest, u16 *pDestLen);
...
*              4. If this function works SUCCESS,<*pDestLen> will return the bytes of <pDest> buffer that has been written.
******************************************************************************/
extern ol_bool LIB_SMS_ConvCharSetToAlpha(LIB_SMS_CharSetEnum eCharSet,u8 *pSrc,u16 uSrcLen,u8 uDCS,u8 *pDest,u16 *pDestLen);
...
*              4. If this function works SUCCESS,<*pDestLen> will return the bytes of <pDest> buffer that has been written.
******************************************************************************/
extern ol_bool LIB_SMS_ConvAlphaToCharSet(u8 uDCS,u8 *pSrc,u16 uSrcLen,LIB_SMS_CharSetEnum eCharSet,u8 *pDest,u16 *pDestLen);
...
*              2. Please ensure all parameters are VALID.
******************************************************************************/
extern ol_bool LIB_SMS_DecodePDUStr(char *pPDUStr,u16 uPDUStrLen,LIB_SMS_PDUParamStruct *pParam);
...
*              2. Please ensure all parameters are VALID.
******************************************************************************/
extern ol_bool LIB_SMS_EncodeSubmitPDU(LIB_SMS_PDUParamStruct *pParam,LIB_SMS_PDUInfoStruct *pInfo);
