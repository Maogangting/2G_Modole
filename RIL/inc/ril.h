/*==========================================================================
 ...
 | File Description
 | ----------------
 |      This file defines interfaces which are used in many files.
...
typedef enum {
    ...
    URC_SYS_BEGIN = 0,
	  ...
	  URC_DTMF_STATE_IND,
	  URC_GTPOS_STATE_IND,
    URC_SYS_INIT_STATE_IND,
    URC_CALL_STATE_IND,
    URC_MQTT_NUM_IND,
    URC_MQTT_MESSAGE_IND,
    URC_ALIMQTT_MESSAGE_IND,
    URC_ALIMUTH_MESSAGE_IND,
    URC_ALIRECONNECT_MESAGE_IND,
    URC_SYS_END = 100,
    /*****************************************/
